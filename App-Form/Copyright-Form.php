...
<style>
            ...
            <div class="rs-breadcrumbs img8">
                <div class="container">
                    <div class="breadcrumbs-inner">
                        <h1 class="page-title">
                            Copyright Your Trademark </br> in the United States.
    ...
    <option value="Zimbabwe">Zimbabwe</option>
                                        ...
                                        <div class="row" id="OrganizationInfo">
                                            <div class="col-lg-12 col-md-12 col-sm-12 mb-30">
                                                <label for="SelectWorkAuthor">Was the Author work made for here?<span class="sub-text" style="font-size: 24px;">*</span></label>
                                                <div class="d-flex inline-block">
                                                    <input class="woocommerce-form__input woocommerce-form__input-checkbox mr-25 ml-25" value="Yes" type="radio" id="Publish5" name="WorkAuthor" required="">
                                                    <label for="Publish5">Yes</label>
                                                    <input class="woocommerce-form__input woocommerce-form__input-checkbox mr-25 ml-25" value="No" type="radio" id="Publish6" name="WorkAuthor" checked required="">
                                                    <label for="Publish6">No</label>
                                                </div>
                                            </div> 
                                            <div class="col-lg-12 col-md-12 col-sm-12 mb-30">
                                                <label for="SelectWorkAnonymously">Author Work made Anonymously? <span class="sub-text" style="font-size: 24px;">*</span></label>
                                                <div class="d-flex inline-block">
                                                    <input class="woocommerce-form__input woocommerce-form__input-checkbox mr-25 ml-25" value="Yes" type="radio" id="Publish7" name="WorkAnonymously" required="">
                                                    <label for="Publish7">Yes</label>
                                                    <input class="woocommerce-form__input woocommerce-form__input-checkbox mr-25 ml-25" value="No" type="radio" id="Publish8" name="WorkAnonymously" checked required="">
                                                    <label for="Publish8">No</label>
                                                </div>
                                            </div>
                                            <div class="col-lg-12 col-md-12 col-sm-12 mb-30">
                                                <label for="SelectWorkPseudonym">Work Created Under a Pseudonym? <span class="sub-text" style="font-size: 24px;">*</span></label>
                                                <div class="d-flex inline-block">
                                                    <input class="woocommerce-form__input woocommerce-form__input-checkbox mr-25 ml-25" value="Yes" type="radio" id="Publish9" name="WorkPseudonym" required="">
                                                    <label for="Publish9">Yes</label>
                                                    <input class="woocommerce-form__input woocommerce-form__input-checkbox mr-25 ml-25" value="No" type="radio" id="Publish10" name="WorkPseudonym" checked required="">
                                                    <label for="Publish10">No</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="rs-pricing style1 " id="Packages">
                                                <div class="container">
                                                   <div class="row">
                                                       <div class="">
                                                            <h3 class="mt-20">
                                                               Package <span class="sub-text big">  </span> 
                                                            </h3>
                                                        </div>
                                                       <div class="col-lg-4 col-md-4 md-mb-30 md-mb-0 sm-mb-30">
                                                           <div class="pricing-table white-bg">
                                                               <div class="btn-part">
                                                                   <a class="readon consultant w-100" href="javascript:void(0);">Live Chat</a>
                                                               </div>
                                                                <div class="pricing-table-header">
                                                                    <h3 class="table-title">Choose a Package</h3>
                                                                </div>
                                                                <div class="pricing-table-price">
                                                                    <p>All Packages include Lifetime Customer Support &amp; Our 100% Money Back Guarntee.</p>
                                                                </div>
                                                           </div>
                                                       </div>
                                                       <div class="col-lg-4 col-md-4 md-mb-30 md-mb-0 sm-mb-30" id="basic">
                                                           <div class="pricing-table white-bg">
                                                                <div class="pricing-table-header">
                                                                ...
                                                                <div class="pricing-table-price">
                                                                    ...
                                                                    <p>+ USCO Filing Free</p>
                                                                </div>
                                                               <div class="btn-part" id="basic-pkge">
                                                                   <a class="readon pkg consultant w-100" href="javascript:void(0);">Choose Package</a>
                                                               </div>
                                                           </div>
                                                       </div>
                                                       <div class="col-lg-4 col-md-4 md-mb-30 md-mb-0 sm-mb-30" id="standard">
                                                           <div class="pricing-table white-bg">
                                                                <div class="pricing-table-header">
                                                               ...
                                                               <div class="btn-part" id="standard-pkge">
                                                                   <a class="readon pkg consultant w-100" href="javascript:void(0);">Choose Package</a>
                                                               </div>
                                                           </div>
                                                       </div>
                                                             ...
                                                             <form>
                                                                 <div class="ordered-product">
                                                                     ...
                                                                     <table>
                                                                         ...
                                                                         <tbody>
                                                                             <tr>
                                                                                 <td><strong class="pkge-Name"></strong></td>
                                                                                 <td class="pkge-Amount"></td>
                                                                             </tr>
                                                                         </tbody>
                                                                         <tfoot>
                                                                             <tr>
                                        ...
                                        <input hidden type="text" id="PackageName" name="PackageName" />
                                        <input hidden type="text" id="PackageAmount" name="PackageAmount" />
                                        
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 mb-30 pl-20">
                                                ...
                                                <label for="CheckTerms">I Accept The Terms. I Have Read, Understand & Agree To The Terms of Service.</label>
                                            </div>
                                        </div>
                                        <div class="btn-part" id="check-out-btn">                                            
                                            <div class="form-group mb-0">
                                                <button class="readon submit w-100" id="submit-form" name="Copyright_sbmit_btn" type="submit">Checkout Now</button>
                                            </div>
                                        </div> 
                                    </fieldset>
                                </form> 
